...
Luego por cada empleado se ingresarán por teclado el Código de Empleado y las horas que trabajó en el mes (entero de 0 a 168). En base a las horas trabajadas y el importe que cobra por hora se debe actualizar el sueldo a cobrar en el archivo. En caso de no encontrar el Empleado en el archivo debe guardarse el error en un archivo llamado Errores.dat con la siguiente estructura (Código de Empleado y Horas Trabajadas).
